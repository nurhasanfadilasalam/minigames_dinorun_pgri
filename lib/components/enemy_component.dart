...
import 'package:minigame/manager/game_manager.dart';
import 'package:minigame/models/enemy_model.dart';

//
// This class is used to represent an enemy component
// that has sprites run in a single cyclic animation.
//
class EnemyComponent extends SpriteAnimationComponent with CollisionCallbacks, HasGameRef<GameManager> {
