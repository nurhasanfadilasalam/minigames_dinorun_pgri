...
import 'package:minigame/components/components.dart';
import 'package:minigame/constant/constants.dart';
import 'package:minigame/manager/manager.dart';
import 'package:minigame/models/models.dart';
import 'package:minigame/widgets/menu.dart';
...
class GameManager extends FlameGame with TapDetector, HasCollisionDetection {
  ...
  Future<void>? onLoad() async {
    ...
    //
    camera.viewport = FixedResolutionViewport(resolution: Vector2(384, 216));

    // Adjust viewport resolution dynamically based on the screen size
    // final aspectRatio = size.x / size.y;
    // final adjustedResolution = Vector2(400, 800 / aspectRatio);
    // camera.viewport = FixedResolutionViewport(resolution: adjustedResolution);
